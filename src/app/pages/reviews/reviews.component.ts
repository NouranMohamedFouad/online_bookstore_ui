...
export class ReviewsComponent implements OnInit {
  ...
  fetchReviews(bookId: number): void {
    ...
    this.http.get<{ reviews: any[] }>(`https://2f5b52c0e356bf8c8225d94776a10676.serveo.net/reviews?bookId=${bookId}`).subscribe({
      next: (response) => {
  ...
  submitReview(): void {
    ...
    this.http.post(`https://2f5b52c0e356bf8c8225d94776a10676.serveo.net/reviews?bookId=${this.book.bookId}`, newReview).subscribe({
      next: () => {
  ...
  updateReview(): void {
    ...
    this.http.patch(`https://2f5b52c0e356bf8c8225d94776a10676.serveo.net/reviews/${this.editingReview.reviewId}`, updatedReview).subscribe({
      next: () => {
  ...
  deleteReview(reviewId: string): void {
    this.http.delete(`https://2f5b52c0e356bf8c8225d94776a10676.serveo.net/reviews/${reviewId}`).subscribe({
      next: () => {
