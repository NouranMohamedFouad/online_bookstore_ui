...
export class ReviewsComponent implements OnInit {
  ...
  fetchReviews(bookId: number): void {
    ...
    this.http.get<{ reviews: any[] }>(`https://4d159b85bafde32829655fa3b417cf80.serveo.net/reviews?bookId=${bookId}`).subscribe({
      next: (response) => {
  ...
  submitReview(): void {
    ...
    this.http.post(`https://4d159b85bafde32829655fa3b417cf80.serveo.net/reviews?bookId=${this.book.bookId}`, newReview).subscribe({
      next: () => {
  ...
  updateReview(): void {
    ...
    this.http.patch(`https://4d159b85bafde32829655fa3b417cf80.serveo.net/reviews/${this.editingReview.reviewId}`, updatedReview).subscribe({
      next: () => {
  ...
  deleteReview(reviewId: string): void {
    this.http.delete(`https://4d159b85bafde32829655fa3b417cf80.serveo.net/reviews/${reviewId}`).subscribe({
      next: () => {
